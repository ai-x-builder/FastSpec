...
The approved product behavior is in `specs/05-feature-tech-gate-clarification-questions/PRODUCT.md`. This change updates the Markdown skill instructions that govern spec workflow behavior after `TECH.md` is written.
